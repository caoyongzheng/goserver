...
import (
	...
	"github.com/caoyongzheng/test/services/blog/model/blog"
	"github.com/caoyongzheng/test/services/blog/model/blogComment"
...
func Get(r render.Render, req *http.Request) {
	...
	bc, _ := blogCommentM.GetPage(blogID, page, pagesize)
